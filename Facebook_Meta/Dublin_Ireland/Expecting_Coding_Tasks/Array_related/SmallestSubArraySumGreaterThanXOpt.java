class SmallestSubArraySumGreaterThanXOpt {

    // Optimized version
    // CREDITS http://www.geeksforgeeks.org/minimum-length-subarray-sum-greater-given-value/
    //         Contributed by Mayank Jaiswal

    /* PROBLEM
     * Given an array of integers and a number x,
     * find the smallest subarray with sum greater than the given value.
     * i.e. it returns length of smallest subarray with sum greater than x.
