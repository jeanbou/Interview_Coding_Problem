// CREDITS: http://practice.geeksforgeeks.org/problems/print-leaf-nodes-from-preorder-traversal-of-bst/0
...
class BinaryTree {
    ...
    // Tree. It returns the root of tree
    Node convertExpression(char[] expression, int i) {
        ...
        // current node
        if (i < expression.length && expression[i] == '?') root.left = convertExpression(expression, i + 1);
